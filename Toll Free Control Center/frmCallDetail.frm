...
Begin VB.Form frmCallDetail 
   ...
   Begin TrueDBGrid80.TDBGrid TDBGrid1 
      Bindings        =   "frmCallDetail.frx":0000
      Height          =   3450
      Left            =   285
      TabIndex        =   0
      Top             =   585
   ...
   Begin BoWSmartUI.SmartUI smartStatus 
      ...
      _ExtentX        =   16642
      _ExtentY        =   635
      Template        =   "frmCallDetail.frx":0014
   End
   Begin BoWSmartUI.SmartUI smartToolBar 
      ...
      _ExtentX        =   16642
      _ExtentY        =   794
      Template        =   "frmCallDetail.frx":082C
   End
End
Attribute VB_Name = "frmCallDetail"
